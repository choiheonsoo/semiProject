 ...
 */
@WebServlet("/board/informationboard.do")
public class InformationServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int numPerpage=10;
		List<Bulletin> bulletins = getService().selectBoardAll(cPage,numPerpage,type,keyword,1);
		
		int totalData = getService().selectBoardCount(1);
