...
<section id=changePwSection>
	<div id="changePwContainer">
		...
		<form action="<%=request.getContextPath()%>/user/sendpw.find" onsubmit="return checkForm()" method="post" id="contactForm" name="changePwForm" >
			...
			<input type="password" class="" id="newPw" name="newPw"	placeholder=" 새 비밀번호를 입력하세요" 
			onfocus="this.placeholder = ''"	onblur="this.placeholder = ' 새 비밀번호를 입력하세요'"> 
			
			<input type="password" class="" id="checkPw" name="checkPw"	placeholder=" 새 비밀번호를 한번 더 입력하세요" 
